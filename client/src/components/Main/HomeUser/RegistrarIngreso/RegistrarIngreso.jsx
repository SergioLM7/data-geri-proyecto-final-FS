      ...
      <div className="modal-content">
        ...
        {confirmationMessage ? (confirmationMessage && (
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <input type="text" {...register('nombre_paciente', { required: 'El nombre es necesario', pattern: {value: /^[A-Za-zÁÉÍÓÚáéíóúÀÈÌÒÙàèìòùÂÊÎÔÛâêîôûÄËÏÖÜäëïöüÿÇçÑñ]+$/i, message: 'El nombre solo admite letras'}, minLength: {value: 2, message: 'Nombre debe tener más de dos caracteres'}, maxLength: {value:50, message: 'El nombre no puede tener más de 50 caracteres' }})} placeholder="Nombre paciente" />
            {errors.nombre_paciente && <p>{errors.nombre_paciente.message}</p>}

            <input type="text" {...register('apellido_paciente', { required: 'El apellido es necesario', pattern: {value: /^[A-Za-zÁÉÍÓÚáéíóúÀÈÌÒÙàèìòùÂÊÎÔÛâêîôûÄËÏÖÜäëïöüÿÇçÑñ]+$/i, message: 'El apellido solo admite letras'}, minLength: {value: 3, message: 'El apellido debe tener más de 3 caracteres'}, maxLength: {value:50, message: 'El apellido no puede tener más de 50 caracteres' } })} placeholder="Apellido paciente" />
