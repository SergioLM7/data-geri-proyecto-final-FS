      ...
      <section className='register-medico'>
        ...
        {!confirmationMessage && (
          <form onSubmit={handleSubmit(onSubmit)}>
            <input type="text" {...register('nombre_medico', {
            ...
            <input type="text" {...register('apellido_medico', {
              required: 'Apellido es requerido', pattern: {
                value: /^[A-Za-zÁÉÍÓÚáéíóúÀÈÌÒÙàèìòùÂÊÎÔÛâêîôûÄËÏÖÜäëïöüÿÇçÑñ\s'-]+$/i
                , message: 'El apellido solo admite letras'
              }, minLength: { value: 3, message: 'El apellido debe tener más de 3 letras' }, maxLength: { value: 70, message: 'El apellido debe tener menos de 70 caracteres' }
            ...
            <input type="number" {...register('id_colegiado', { required: 'ID Colegiado es requerido', pattern: {value: /^\d+$/i, message: 'El ID solo admite números'}, minLength: { value: 3, message: 'El ID debe tener, al menos, 3 cifras' }, maxLength: { value: 20, message: 'El ID debe tener, máximo, 20 cifras' }, min: { value: 1, message: 'El ID no puede ser menor que 1' } })} placeholder="ID Colegiado" />
